...
# You Must Use Google Docs to Prepare the Essay! 

You must use [Google Docs](INSERT HERE) in all steps of preparing your document (e.g, notes, drafts). 

All ASU students have free access to Google Drive (which includes Google Docs). If you have never used Google Drive/Docs, or would like a reminder on how to access [CLICK HERE](INSERT HERE).
...
**And lastly - THIS STEP IS CRITICAL - you will share your Google Doc with your assigned Course Assistant. [Go here for instructions](INSERT HERE).** 
...
Length, 2 pages single-spaced; 1” margins; 12 pt., Times New Roman font. You must follow these formatting requirements. When you do so, your essay will be around 750-850 words. If you include a reference section (optional), please submit as a 3rd page.  
...
Ok- We finally get to what you need to write about. Please respond to the following prompt using your own words and interpretation. 
