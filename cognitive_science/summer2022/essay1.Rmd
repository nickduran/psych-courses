...
Length, 2 pages single-spaced; 1” margins; 12 pt., Times New Roman font. You must follow these formatting requirements. When you do so, your essay will be around 650-750 words. If you include a reference section (optional), please submit as a 3rd page.  
...
**You must also cite more than just the textbook or just my lecture.** There needs be ***AT LEAST*** one other resource cited in addition to the textbook or my lecture for maximum points.    
:::
...
-   **Dimension 1: Overall Writing Quality**
    - Did the author organize his or her response in a way that is logical and clear? What is easy to follow the flow of ideas across the entire essay?
    - Do the word choices convey a formal and academic writing style?
    - How well did the author demonstrate a good grasp of standard writing conventions (e.g., spelling, punctuation, capitalization, grammar, usage, paragraphing)?
-   **Dimension 2: Featuring/Integrating Resources from the Learning Materials**
    - Did the author attempt to feature resources from the module learning materials in obvious and substantial ways? NOTE: Do not evaluate on whether the resources were used effectively and persuasively, that is for the next item!
-   **Dimension 3: Using Core Ideas to Demonstrate Knowledge**
    - Did the author provide a knowledgeable and persuasive response that effectively answers the thought question prompt?
