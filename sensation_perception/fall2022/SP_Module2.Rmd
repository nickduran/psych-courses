...
It appears you have neurons that respond uniquely to general complex shapes and targeted environmental stimuli, such as faces, bodies, and places. 

1. What types of neurons do you think would fire to the stimulus below and why? 

2. And what do you think someone with prosopagnosia or Charles Bonnet syndrome might experience? 
...
```{r, echo=FALSE,out.width="65%", out.height="20%",fig.cap="Octavio Campo - 'Por Siempre'",fig.show='hold',fig.align='center'}
# knitr::include_graphics(c("Picture1.jpeg", "Picture2.png")) 
knitr::include_graphics(c("Picture3.jpg"))

```

<!-- ![alt text here](Picture3.jpg) -->
