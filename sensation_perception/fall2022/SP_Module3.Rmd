...
As you can see (no pun intended), our ability to perceive the world around us is incredibly complex - but we also tend to take this ability for granted. So here is a little challenge: 

Imagine you are a vision scientist who has been hired by a small tech company that is designing a new digital camera that can identify and tag objects, people, and scenes in the pictures it takes (similar to how a human would). Your job is to explain the following to the developers:

1. What kinds of challenges will they face? 

2. How do humans overcome those challenges?
...
**Important Note:** You are writing an argumentative essay that should rely on facts, mechanisms, and/or theories. DO NOT give anecdotes, personal opinion, or commentary pulled from thin air. Using your own examples from time to time is OK if it helps bring clarity to some specific argument/point. But I want evidence that you interacted with the learning materials!
