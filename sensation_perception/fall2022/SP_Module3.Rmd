...
```{r, include=FALSE}
# What is the difference and relationship between sensation and perception? Is there any way to tell whether the world we “see” in our minds is the same as the external world - and whether we see things as most others do?
```
